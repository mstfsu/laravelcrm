                    ...
                    <form>
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="email" id="email" class="form-control" placeholder="Email" autocomplete="off" autocomplete="false" />
                            </div>
...
@section('page-script')
    ...
    <script src="{{ asset( 'js/scripts/User/add.js') }}"></script>
    <script>
        var remoteData = {
