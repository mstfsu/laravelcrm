            ...
            .on('click', function () {
                ...
                if (isValid) {
                    ...
                    $.ajax({
                        ...
                        data:  {company:company,id:id, role:role,password:password, full_name:full_name,email:email,country:country,city:city,address:address,pincode:pincode,phone:phone,owner:owner,latitude:latitude,longitude:longitude , state:state} ,
